...
NioApp = (function (NioApp, $, window, document) {
    ...
    NioApp.Util.browser = function () {
        var isChrome = navigator.userAgent.indexOf("Chrome") !== -1 ? 1 : 0,
            ...
            isSafari =
                navigator.userAgent.indexOf("Safari") !== -1 ? true : false,
            isIE =
        ...
        if ($count.exists()) {
            $count.each(function () {
                ...
                var _hour_text = $self.data("hour-text")
                    ? $self.data("hour-text")
                    : "Hours";
                var _min_text = $self.data("min-text")
                    ? $self.data("min-text")
                    : "Min";
                var _sec_text = $self.data("sec-text")
                    ? $self.data("sec-text")
                    : "Sec";
                $self
                    .countdown(datetime)
    ...
    NioApp.Plugins.carousel = function () {
        ...
        if ($carousel.exists()) {
            $carousel.each(function () {
                ...
                var cim_l = $self.data("items-desk")
                ...
                var cim_xm = $self.data("items-mobile-s")
                    ...
                    : cim_m;
                var c_timeout = $self.data("timeout")
                    ? $self.data("timeout")
                    : 6000;
        ...
        function fixing_blank(_this) {
            ...
            if (!_self.hasClass("blank-added") && $win.width() > 575) {
                _self.trigger("add.owl.carousel", [
                ...
                var $this = $(this),
                    ...
                    opacity_value =
                        typeof opacity !== "undefined" && opacity
                            ...
                            : false,
                    cover_value =
                        typeof cover !== "undefined" && cover ? cover : false;
